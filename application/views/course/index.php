                        ...
                        <div class="modal-body">
                            <form name="myForm" method="post" id="createCityForm" onsubmit="return addCity();">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="cdate" name="cdate" placeholder="Enter Subject date" />
                                </div>
                        ...
                        <div class="modal-body">
                            <form name="myForm" method="post" id="updateCityForm" onsubmit="return updateCity();">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="update_cshort" name="cshort" placeholder="Enter Course Short" />
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="update_cdate" name="cdate" placeholder="Enter Subject date" />
                                </div>
                                <div class="mb-3">
                                    <label for="update_update_date" class="form-label">Update date</label>
                                    <input type="date" class="form-control" id="update_update_date" name="update_date" placeholder="Enter Update date" />
                                </div>
