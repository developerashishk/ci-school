                        ...
                        <div class="modal-body">
                            <form name="myForm" method="post" id="updateCityForm" onsubmit="return updateCity();">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="update_name" name="name" placeholder="Enter Updated State Name" />
                                </div>
                                <div class="mb-3">
                                    <label for="update_country_id" class="form-label">Country Id</label>
                                    <input type="text" class="form-control" id="update_country_id" name="country_id" placeholder="Country Id" />
                                </div>
